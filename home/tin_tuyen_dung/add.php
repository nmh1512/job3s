...
if (!empty($_POST)) {
    $ceate_date = strtotime(date('Y-m-d'));
...
<body>
                            ...
                            <div class="form_group chil_div16">
                                ...
                                <div class="d_flex w_100">
                                    ...
                                    <div class="w_50pt ml_24">
                                        ...
                                        <div class="d_flex align_c mt_5 w_100 br_5 custom_select">
                                            <select name="district" class="select_one quan_huyen" data-placeholder="Chọn quận/huyện" data-minimum-results-for-search="Infinity">
                                                <!-- <option value=""></option>
                                                <option value="0">Hà Nội</option>
                                                <option value="1">Hồ Chí Minh</option>
                                                <option value="3">Đà Nẵng</option>
    ...
    <? if(isset($_COOKIE['dang_tin'])):?>
    <div class="popup" id="danh_gia_ss" onloadeddata="viewAndClosePopupUpdate('#danh_gia_ss', '.main_popup', '.close_popup', '.cancel', '', false)">
        <div class="main_popup bg_white popup_500 br_20 animation_zoom_in">
            <div class="conatent_popup pd_t32_lrb24">
                <div class="d_flex center_center flex_column">
                    ...
                    <p class="font_s16 line_h19 font_w400 cl_55 mt_8 txt_center">Đăng tin thành công!</p>
                    <div class="form_submit d_flex center_center mt_16">
                        <a href="/tin-tuyen-dung/" class="btn flex_im center_center h_42 m_w140 br_5 font_s16 line_h19 font_w700 bg_td cl_white btn_primary">Đóng</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        FindKey({
            arr: <?= json_encode($city) ?>,
            key: 'cit_parent',
            value: 0,
            selectApp: '.tinh_thanh',
            selecteChild: '.quan_huyen',
            keyID: 'cit_id',
            keyName: 'cit_name'
        })
