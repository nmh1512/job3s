    ...
    <div class="main_container pd_24">
      <div class="box_shadow border_c4 pd_24 d_flex">
        <img
          ...
          alt=""
          class="border_r16 wh_120px border_dc"
        />
        <div class="ml_16">
          ...
          <div id="btnContainer" class="mt_24 d_flex">
            ...
            <button
              data-id="popupShare"
              class="ml_16 btn_bg_white d_flex align_c flex_center plr_24"
            >
            ...
            <button
              data-id="popupRefresh"
              class="ml_16 btn_r100 border_or orange d_flex align_c flex_center plr_24"
            >
        ...
        <div class="d_flex mt_16">
          <div class="box_8px box_thongke_uv">
            <div class="progressbar position_r mb_8">
              ...
              ></div>
              <span
                class="progressbar_value orange font_s14 font_w500 position_a"
                >50%</span
              >
            </div>
      ...
      <div class="box_shadow pd_24 mt_24">
        <div class="d_flex space_b">
          ...
          <div
            class="d_flex align_c flex_center font_s18 main_color font_w500 cursor_p"
          >
        ...
        <div class="mt_24 info_ungvien">
          <form action="">
            <div class="d_flex">
              ...
              <div class="div_input mt-0">
                <label for="" class="font_w500"
                  >Giới tính<span class="color_red">*</span></label
                >
                <div class="input_container">
                  <select
                    class="select_form"
              ...
              <div class="div_input">
                ...
                <div class="input_container">
                  <select
                    class="select_form"
                    name=""
                    data-placeholder="Chọn tình trạng hôn nhân"
                  >
                    <option value=""></option>
                  </select>
                </div>
            ...
            <div class="d_flex flex_column mt_16">
              <label for="" class="font_w500"
                >Địa chỉ<span class="color_red">*</span></label
              >
            ...
            <div class="d_flex">
              <div class="div_input">
                <label for="" class="font_w500"
                  >Số điện thoại<span class="color_red">*</span></label
                >
                <div class="input_container">
            ...
            <div class="d_flex">
              <div class="div_input">
                <label for="" class="font_w500"
                  >Vị trí công việc<span class="color_red">*</span></label
                >
                <div class="input_container">
                  <select
                    class="select_form"
                    name=""
                    data-placeholder="Chọn vị trí công việc"
                  >
                    <option value=""></option>
                  </select>
                </div>
              ...
              <div class="div_input">
                <label for="" class="font_w500"
                  >Kinh nghiệm làm việc<span class="color_red">*</span></label
                >
                <div class="input_container">
                  <select
                    class="select_form"
                    name=""
                    data-placeholder="Chọn kinh nghiệm làm việc"
                  >
                    <option value=""></option>
                  </select>
                </div>
            ...
            <div class="mt_16">
              ...
              <textarea
                ...
                cols="30"
                rows="5"
                placeholder="Thêm giới thiệu bản thân để nhà tuyển dụng có thể hiểu hơn về bạn"
              ></textarea>
            </div>
            <div class="form_btns">
              <button
                type="button"
                class="btn_huy"
                onclick="showPopup('#popupXacNhanHuy')"
              >
                Hủy
              </button>
      ...
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
        <div class="w_100">
          ...
          <div class="mt_24">
            ...
            <form action="">
              <div>
                <label for="" class="font_w500"
                  >Sở thích<span class="color_red">*</span></label
                >
                <textarea
                  class="mt_8"
                  name=""
                  ...
                  cols="30"
                  rows="5"
                  placeholder="Sở thích của bạn là?"
                ></textarea>
              </div>
              <div class="form_btns">
                <button
        ...
        <img hidden src="../../../images/interests.svg" alt="" />
      </div>
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
        <div class="w_100">
          ...
          <div class="mt_24">
            ...
            <form action="">
              <div>
                <label for="" class="font_w500"
                  >Mục tiêu<span class="color_red">*</span></label
                >
                <textarea
                  class="mt_8"
                  name=""
        ...
        <img hidden src="../../../images/target.svg" alt="" />
      </div>
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
            ...
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Trường học<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Chuyên ngành<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="mt_16">
                <div>
                  <label for="" class="font_w500"
                    >Thời gian<span class="color_red">*</span></label
                  >
        ...
        <img hidden src="../../../images/education.svg" alt="" />
      </div>
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
          ...
          <div class="mt_24">
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Tên chứng chỉ<span class="color_red">*</span></label
                  >
                  <div class="input_container">
        ...
        <img hidden src="../../../images/certificate.svg" alt="" />
      </div>
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
          ...
          <div class="mt_24">
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Công ty<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Chức vụ<span class="color_red">*</span></label
                  >
                  <div class="input_container">
        ...
        <img hidden src="../../../images/exp.svg" alt="" />
      </div>
      <div
        class="box_shadow pd_24 mt_24 d_flex space_b align_c info_ungvien_item"
      >
          ...
          <div class="mt_24">
            <form action="">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Tên kỹ năng<span class="color_red">*</span></label
                  >
                  <div class="input_container">
          ...
          <div class="mt_24">
            <form action="">
              <div class="d_flex">
                <div class="div_input mt-0">
                  <label for="" class="font_w500"
                    >Ngôn ngữ<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <select
                      class="select_form"
                ...
                <div class="div_input mt-0">
                  <label for="" class="font_w500"
                    >Mức độ thành thạo<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <select
                      class="select_form"
          ...
          <div class="mt_24">
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Tên giải thưởng<span class="color_red">*</span></label
                  >
                  <div class="input_container">
          ...
          <div class="mt_24">
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Tên dự án<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Khách hàng<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Số thành viên<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <input
                      type="text"
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Vị trí<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <input
                      type="text"
              ...
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Nhiệm vụ<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <input
                      type="text"
              ...
              <div class="mt_16">
                ...
                <textarea
                  ...
                  cols="30"
                  rows="5"
                  placeholder="Thêm mô tả chi tiết dự án"
                ></textarea>
              </div>
              <div class="form_btns">
                <button
          ...
          <div class="mt_24">
            <form action="" class="form_uv">
              <div class="d_flex">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Tên tổ chức<span class="color_red">*</span></label
                  >
                  <div class="input_container">
                    <input
                      type="text"
                      placeholder="VD: CLB Tình Nguyện Hà Nội"
                    />
                  </div>
                </div>
              </div>
              <div class="d_flex mt_16">
                <div class="div_input mt-0 w_100">
                  <label for="" class="font_w500"
                    >Vị trí tham gia<span class="color_red">*</span></label
                  >
                  <div class="input_container">
              ...
              <div class="mt_16">
                ...
                <textarea
                  ...
                  cols="30"
                  rows="5"
                  placeholder="Mô tả chi tiết về quá trình tham gia hoạt động xã hội của bạn"
                ></textarea>
              </div>
              <div class="form_btns">
                <button
        ...
        <div class="popup_body border_0">
          ...
          <div class="mb_24 popup_link">
            <div class="d_flex">
              ...
              <button
                class="ml_16 border_0 wh_42px d_flex align_c flex_center cursor_p"
              >
          ...
          <div class="conatent_popup pd_t32_lrb24">
            <div class="d_flex center_center flex_column">
              ...
              <div class="form_submit d_flex center_center mt_16">
                <a
                  href=""
                  class="btn flex_im text_c center_center btn_r5 font_s16 line_h19 font_w700 bg_td bg_s_green"
                  >Đóng</a
                >
              </div>
            </div>
