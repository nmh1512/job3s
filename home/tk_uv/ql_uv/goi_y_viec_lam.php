...
<body>
  ...
  <div class="main_container goi_y_viec_container pd_24">
    <div class="box_shadow p_16 mb_24 d_flex align_c space_b bg_wgreen">
      ...
      <img class="cursor_p" src="../../../images/x_black.svg" alt="">
    </div>
    <div class="box_shadow border_c4">
      ...
      <div class="pd_24 info_goiy_viec">
        ...
        <div class="info_goiy_viec_top_form mt_48">
          <form id="formGoiYViecLam" action="">
            <div class="mb_24">
            ...
            <div class="mb_24">
              ...
              <div class="mt_8">
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Ngành nghề<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="nganh_nghe" data-placeholder="Chọn ngành nghề">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="div_input">
                    <label for="" class="font_w500">Vị trí mong muốn<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="vi_tri" data-placeholder="Chọn vị trí ">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Kinh nghiệm<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="kinh_nghiem" data-placeholder="Chọn kinh nghiêm">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="div_input">
                    <label for="" class="font_w500">Trình độ chuyên môn<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="trinh_do" data-placeholder="Chọn trình độ">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Năm sinh</label>
                    <div class="input_container">
                      <select class="select_form" name="" data-placeholder="Chọn năm sinh">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="div_input">
                    <label for="" class="font_w500">Giới tính</label>
                    <div class="input_container">
                ...
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Quê quán</label>
                    <div class="input_container">
                      <select class="select_form" name="" data-placeholder="Chọn quê quán">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
            ...
            <div class="mb_24">
              ...
              <div class="mt_8">
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">CV của chính bạn<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="cv_select" data-placeholder="Chọn CV bạn muốn dùng để ứng tuyển">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                  <div class="div_input">
                    <label for="" class="font_w500">Công việc<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="cong_viec" data-placeholder="Chọn hình thức làm việc mong muốn">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Mức lương<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="muc_luong" data-placeholder="Chọn mức lương mong muốn">
                        <option value=""></option>
                  ...
                  <div class="div_input">
                    <label for="" class="font_w500">Địa điểm làm việc<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="dia_diem" data-placeholder="Chọn địa điểm làm việc">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="d_flex div_input_container">
                  <div class="div_input">
                    <label for="" class="font_w500">Mong muốn làm việc tại nước ngoài<span class="color_red">*</span></label>
                    <div class="input_container select_vali">
                      <select class="select_form" name="mong_muon" data-placeholder="">
                        <option value=""></option>
                      </select>
                    </div>
                  </div>
...
<script>
  ...
  $("#formGoiYViecLam").validate({
        ...
        ho_ten: "Vui lòng nhập họ tên",
				...
				vi_tri: "Vui lòng chọn vị trí mong muốn",
				kinh_nghiem: "Vui lòng chọn kinh nghiệm",
				trinh_do: "Vui lòng chọn trình độ chuyên môn",
				cv_select: "Vui lòng chọn CV của bạn",
				cong_viec: "Vui lòng chọn hình thức làm việc mong muốn",
				muc_luong: "Vui lòng chọn mức lương mong muốn",
				dia_diem: "Vui lòng chọn địa điểm làm việc mong muốn",
				mong_muon: "Bạn có mong muốn làm việc ở nước ngoài không ?"
			}
		});
