    ...
    <div id="root">
        ...
        <div class="container mt_90 pd_b48">
            <div class="banner_cv h_400 bg_cv">
                <div class="content_banner wf_tinhthanh">
                    <div class="heading_cv">
                        <h1 class="font_s28 line_h33 font_w700 cl_primary">Mẫu đơn xin việc chuẩn 2022</h1>
                        <p class="font_16 line_h19 font_w400 cl_55 mt_12">Mẫu đơn xin việc chuyên nghiệp, hiện đại phù hợp với nhiều ngành nghề</p>
                    </div>
                ...
                <div class="img_tt d_flex align_e position_r">
                    <div class="icon_bv d_flex align_c">
                        <img src="../../images/bv_filwhite.png" alt="">
                    </div>
                    <img src="../../images/banner_dxv.png" alt="" />
                    <div class="icon_dx d_flex align_c">
                        <img src="../../images/like_fill_ds.png" alt="">
                    </div>
                </div>
            </div>
            <div class="cv_warp d_flex pd_lr68 mt_24">
                ...
                <div class="cv_right">
                    <h2 class="font_s24 line_h28 font_w500 cl_primary txt_center">Danh sách mẫu Đơn xin việc đẹp nhất hiện nay</h2>
                    <div class="slider_list_cv mt_24 ">
                        <div class="row row_cv">
                            <?php for ($i = 0; $i < 12; $i++) : ?>
                                <div class="item_cv col_3 hover_itemcv">
                                    <div class="cv_img">
                                        <img src="../../images/dxv_1.png" alt="" class="img_full br_cv">
                                    </div>
