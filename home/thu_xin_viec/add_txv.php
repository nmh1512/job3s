    ...
    <div class="popup hidden" id="save_xv">
        <div class="main_popup bg_white popup_500 br_20 animation_zoom_in">
            <div class="header_popup position_r btn_primary d_flex center_center pd_19_18 hd_popup">
                <h3 class="font_s20 line_h23 cl_white font_w700">Lưu sơ yếu lý lịch</h3>
            ...
            <div class="conatent_popup pd_tlr32_b24">
                <form onsubmit="return false" action="" method="POST" class="form_check">
                    <div class="form_group">
                        <span class="font_s16 line_h19 font_w500 cl_a4">Tiêu đề sơ yếu lý lịch<span class="cl_red">*</span></span>
                    ...
                    <span class="vd_po">Ví dụ: Sơ yếu lý lịch việc làm bán hàng,...</span>
        ...
        <div class="main_popup bg_white popup_500 br_20 animation_zoom_in">
            ...
            <div class="conatent_popup pd_24_32">
                <form onsubmit="return false" action="" method="POST">
                    <p class="font_s16 line_h19 font_w400 cl_a4 txt_center">Lần tạo mới <span class="font_w500">Sơ yếu lý lịch</span> cuối cùng của bạn chưa được lưu, bạn có muốn khôi phục lại không?</p>
                    <div class="form_submit d_flex center_center mt_24">
        ...
        <div class="main_popup bg_white popup_500 br_20 animation_zoom_in">
            <div class="conatent_popup pd_t32_lrb24">
                <div class="d_flex center_center flex_column">
                    ...
                    <h3 class="font_s20 line_h23 font_w700 cl_primary mt_16">Lưu SYLL thành công!</h3>
                    <p class="font_s16 line_h19 font_w400 cl_55 mt_8 txt_center">Giờ đây bạn có thể dùng SYLL này để ứng tuyển các công việc phù hợp! </p>
                    <div class="form_submit d_flex center_center mt_16">
                        <a href="/so-yeu-ly-lich/" class="btn flex_im center_center h_42 m_w140 br_5 font_s16 line_h19 font_w700 bg_td cl_white btn_primary">Đóng</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="fuc_controll">
                <div class="list_control_fuc">
                    ...
                    <div class="item_control_fuc doi_mau_cv">
                        <span class="font_s16 line_h19 font_w500 cl_55">Đổi mẫu SYLL</span>
                    ...
                    <div class="item_control_fuc save_xv">
                        <span class="font_s16 line_h19 font_w500 cl_55">Lưu SYLL</span>
                        <div class="list_c w_138 flex_center">
                            <button class="btn flex_im center_center wh_28 br_50pt">
