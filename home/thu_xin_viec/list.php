                        ...
                        <div class="row row_cv">
                            <?php for ($i = 0; $i < 12; $i++) : ?>
                                <div class="item_cv col_3 hover_itemcv">
                                    <div class="cv_img">
                                        <img src="../../images/mau_syll.png" alt="" class="img_full br_cv">
                                    </div>
                                    ...
                                    <div class="overlay_cv">
                                        <div class="child_17">
                                            ...
                                            <a href="/thu-xin-viec/tao-thu-xin-viec" class="btn btn_hover_primary flex_im center_center br_100 btn_primary cl_white">
                                                <div class="mr_6 d_flex align_c">
                                                    <img src="../../images/edit_white.png" alt="">
                                                </div>
