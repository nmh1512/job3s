            ...
            <div class="content wbjsb mt_90 pd_24 chil_24">
                <div class="box_cty">
                    <div class="d_flex align_c space_b">
                        <h2 class="font_s24 line_h28 font_w700 cl_primary bd_l4 pd_l8">Sơ yếu lý lịch đã lưu</h2>
                        <div>
                            <a href="/tin-tuyen-dung/dang-tin-tuyen-dung.html" class="btn btn_hover_primary flex_im align_c br_100 btn_primary cl_white pd_t12_b11_lr24">
                                ...
                                <span class="font_s16 line_h19 font_w500 currentColor">Tạo sơ yếu lý lịch</span>
                            </a>
                        </div>
                    </div>
                    <div class="mt_24">
                                ...
                                <div class="col_3 txv_item br_16 over_hd">
                                    ...
                                    <div class="txv_content">
                                        <div class="txv_content_top position_r ">
                                            <h3 class="font_s16 line_h19 font_w700 cl_white pd_r28">ĐÂY LÀ TIÊU ĐỀ SƠ YẾU KÝ LỊCH</h3>
                ...
                <div class="box_cty">
                    <div class="d_flex align_c space_b">
                        <h2 class="font_s24 line_h28 font_w700 cl_primary bd_l4 pd_l8">Sơ yếu lý lịch đã thích</h2>
                    </div>
                    <div class="mt_24">
                        <div class="row row_g36">
                            <?php for ($i = 0; $i < 3; $i++) : ?>
