    ...
    <section>
      <div class="tuyendung_container main_container">
        <div class="d_flex align_c space_b btn_header_container">
          ...
          <a class="btn_chung bg_s_green" href=""
            ><img src="../images/plus.svg" alt="" />Thêm dịch vụ</a
          >
        </div>
        <div class="tuyendung_content">
          <div class="tuyendung_content_navbar">
            <ul>
            <li>
                <a href="dich-vu-dang-chay.html" class="font_w700"
                  >Đang chạy</a
                >
              </li>
              <li>
                <a href="dich-vu-het-han.html" class="font_w700 nav_active"
                  >Đã hết hạn</a
                >
              </li>
            </ul>
          ...
          <div class="thong_ke_table_container">
            <div class="tuyen_dung_filter d_flex align_c space_b">
              ...
              <div
                class="d_flex align_c space_b select_filter_box filter_my_service"
              >
              ...
              <table class="w_100 table_list_cv table_collapse table_ungvien">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="main_color font_w500">Nạp Credit mở hồ sơ ứng viên (1000C) <span class="d_flex align_c flex_center"><img src="../images/clock_white.svg" alt="">Gia hạn</span></td>
