      ...
      <div class="tuyendung_container main_container">
        <div class="d_flex align_c space_b btn_header_container">
          ...
          <div class="d_flex align_c">
            ...
            <button
              class="btn_chung bg_s_green cursor_p position_r show_popup_choose" onclick="show_popup_choose(this)"
            >
        ...
        <div class="tuyendung_content">
          <div class="tuyendung_content_navbar">
            <ul>
              <li>
                <a href="tin-tuyen-dung.html" class="nav_active font_w700">Tin tuyển dụng</a>
              </li>
              <li>
